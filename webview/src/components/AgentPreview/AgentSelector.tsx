...
export interface StopClickParams {
  endSession: () => unknown;
}

export const handleStopClickImpl = ({ endSession }: StopClickParams) => {
  endSession();
};
      ...
      {selectedAgent &&
        (selectedAgentInfo?.type === 'published' ? (
          <Button
            appearance="primary"
            size="small"
            onClick={isSessionStarting ? handleStopClick : handleStartClick}
            className="agent-selector__start-button"
            disabled={isLoading}
            startIcon={
              isSessionStarting || isSessionActive ? (
          ...
          >
            {isSessionStarting ? 'Stop' : isSessionActive ? 'Stop Live Test' : 'Start Live Test'}
          </Button>
        ) : (
          <SplitButton
            appearance="primary"
