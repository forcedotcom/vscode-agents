...
export class AgentPreviewProvider implements vscode.WebviewViewProvider {
  public static readonly viewType = 'sf.agent.preview.view';
  ...
  public resolveWebviewView(
    ...
    webviewView.webview.options = {
      enableScripts: true,
      localResourceRoots: [vscode.Uri.joinPath(this.context.extensionUri, 'agent-preview', 'dist')]
    };
    ...
    const styleUri = webviewView.webview.asWebviewUri(
      vscode.Uri.joinPath(this.context.extensionUri, 'agent-preview', 'dist', 'assets', 'index.css')
    );
    const indexPath = vscode.Uri.joinPath(this.context.extensionUri, 'agent-preview', 'dist', 'assets', 'index.js');
  ...
  private async saveChatToFile(messages: unknown[]): Promise<void> {
    try {
