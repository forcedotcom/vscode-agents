        ...
        >
          <div className="tracer-steps">
            ...
            <StepTopicSelection
              timing="1.10 sec"
              promptUsed={
                <p>System instructions and context for topic selection for resort weather inquiry...</p>
              }
              availableTopics={
                <p>
                  Weather Service, Location Service, Travel Service, Calendar Service
                </p>
              }
        ...
        >
          <div className="tracer-steps">
            ...
            <StepTopicSelection
              timing="1.20 sec"
              promptUsed={
                <p>System instructions and context for topic selection...</p>
              }
              availableTopics={
                <p>
                  Weather Service, News Service, Calendar Service, Location
                  Service
                </p>
              }
              availableTopicsCount={4}
            ...
            <StepTopic
              ...
              timing="1.15 sec"
              instructions={
                <p>Detailed instructions for using the Weather Service...</p>
              }
              instructionsCount={7}
              availableTopics={
                <p>Available weather-related topics and endpoints...</p>
              }
              availableTopicsCount={4}
            />
            ...
            <StepActionSelection
              timing="0.65 sec"
              promptUsed={<p>System instructions for action selection...</p>}
            />
